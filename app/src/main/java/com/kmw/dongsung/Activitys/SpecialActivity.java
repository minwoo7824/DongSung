...
//
                ...
                new DownloadFilesTask(SpecialActivity.this).execute(VIDEO_URL);
    ...
    void FindViewById(){
        ...
        relaMain = (RelativeLayout)findViewById(R.id.rela_special_main);
        //hover
    ...
    public class WaitingOneNetWork extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            http.addOrReplace("classification","50");
        ...
        protected void onPostExecute(String s) {
            if (s.length() != 0){
                ...
                try {
                    ...
                    adapter = new WaitingViewPagerAdapter(getLayoutInflater(),SpecialActivity.this);
...
//                    for (int i = 0; i < jsonArray.length(); i++){
                        ...
                        if (JsonIsNullCheck(jsonObject,"SCREEN_MODE").equals("1")){
                            Log.i(TAG,"getRotation : " + relaMain.getRotation());
                            if (relaMain.getRotation() > 0){
                                relaMain.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                                    @Override
                                    public boolean onPreDraw() {

                                        int w = relaMain.getWidth();
                                        int h = relaMain.getHeight();

                                        relaMain.setRotation(0.0f);
                                        relaMain.setTranslationX((0));
                                        relaMain.setTranslationY((0));

                                        ViewGroup.LayoutParams lp = (ViewGroup.LayoutParams) relaMain.getLayoutParams();
                                        lp.height = w;
                                        lp.width = h;
                                        relaMain.requestLayout();

                                        relaMain.getViewTreeObserver().removeOnPreDrawListener(this);
                                        return true;
                                    }
                                });
                            }
                            ...
                            if (relaMain.getRotation() > 0){
                                ...
                                relaMain.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                                    ...
                                    public boolean onPreDraw() {
                                        ...
                                        relaMain.setRotation(90.0f);
                                        relaMain.setTranslationX((w - h) / 2);
                                        relaMain.setTranslationY((h - w) / 2);
                    ...
                    if (JsonIntIsNullCheck(jsonObject,"SCREEN_TYPE") == 1){
                        ...
                        new WaitingTwoNetWork(JsonIntIsNullCheck(jsonObject,"SLIDE_SEC")).execute(String.valueOf(statusPlateNo));
    ...
    public class WaitingTwoNetWork extends AsyncTask<String, String, String> {
        ...
        public WaitingTwoNetWork(int sec) {
            this.sec = sec;
        }
                    ...
                    if (screenType == 1) {
                        ...
                        if (JsonIntIsNullCheck(jsonObject, "PRIORITY") == 0) {
                            ...
                            if (VIDEO_URL.length() == 0) {
                                Toast.makeText(SpecialActivity.this, "동영상 형식이 잘못되었습니다.", Toast.LENGTH_SHORT).show();
                            } else {
                                if (pref.getString("videoFile", "").equals(VIDEO_URL)) {
                                    ...
                                    videoView.setVideoPath("file://" + downloadsPath);
                        ...
                        handler = new Handler(){
                            ...
                            public void handleMessage(Message msg) {
                                if (imagePathList.size() > 1){
                                    ...
                                    handler.sendEmptyMessageDelayed(0,(sec * 1000));
                                }else{
                                    handler.removeMessages(0);
                                }
                            }
    ...
    private View.OnClickListener mPopupListenerOk = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mPopupStatus == POPUP_LOGOUT){
                ...
                editor.apply();
                Intent intent = new Intent(SpecialActivity.this, LoginActivity.class);
                ...
                Intent intent = new Intent(SpecialActivity.this, ModeSelectActivity.class);
                startActivity(intent);
            }
        }
    };
...
//            startActivity(intent22);
    ...
    private BroadcastReceiver mUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message.equals("update") && status.equals("특수")){
                new WaitingOneNetWork().execute(pref.getString("funeralNo",""));
            }else if (message.equals("check") && status.equals("connect")){
                intentData = data;
                autorize();
            }else if (message.equals("check") && status.equals("특수")){
                mPopupStatus = 5;
