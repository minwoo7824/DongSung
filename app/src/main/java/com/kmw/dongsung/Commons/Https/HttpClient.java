...
public class HttpClient {
    ...
    private void setContentType1(HttpURLConnection connection) {
        connection.setRequestProperty("Content-Type", WWW_FORM);
        connection.setRequestProperty("X-Naver-Client-Secret", "LeFvi1mw22");
        connection.setRequestProperty("X-Naver-Client-Id", "H6vmniuuRIPYrIPB_J2T");
    }
    private void setRequestMethod(HttpURLConnection connection) {
        ...
        public void addOrReplace1(String key, Object value) {
            this.parameters.put(key, value);
        }
