...
public class PaintTextView extends TextView {
    ...
    private String TAG = "PaintTextView";
    ...
    // Default constructor override
    public PaintTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i(TAG,"getWidth : " + getMeasuredWidth() + " getHeight : " + canvas.getHeight());


        Log.i(TAG,"textSize :  "+ mTextSize);

        String[] test = getText().toString().split("\n");
