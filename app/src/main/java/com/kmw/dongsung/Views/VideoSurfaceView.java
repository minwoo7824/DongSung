...
public class VideoSurfaceView extends GLSurfaceView {
    ...
    public VideoSurfaceView(Context context, File file) {
        super(context);
    ...
    public VideoSurfaceView(Context context, String filePath) {
        super(context);
    ...
    public VideoSurfaceView(Context context, Uri uri) {
        super(context);
